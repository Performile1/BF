...
export const INITIAL_INVOICES: InvoiceRecord[] = [
  ...
  },
  {
    ...
    recipient_email: 'elena@salespeak.io',
    company_name: 'SalesPeak Academy',
    vat_amount_sek: 247.50,
    payment_link: 'https://buy.stripe.com/test_due_elena'
  },
  {
    id: 'inv_2026_amanda_paid',
    invoice_number: 'BF-2026-0903',
    date: '2026-09-01',
    due_date: '2026-09-30',
    amount_sek: 390,
    status: 'PAID',
    ...
    recipient_name: 'Amanda Berg',
    recipient_email: 'amanda@studionorth.se',
    company_name: 'Studio North Creative',
    vat_amount_sek: 97.50,
    pdf_url: '#'
  }
];
